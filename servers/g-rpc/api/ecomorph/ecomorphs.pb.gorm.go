...
func DefaultReadEcomorph(ctx context.Context, in *Ecomorph, db *gorm.DB) (*Ecomorph, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &EcomorphORM{}); err != nil {
		return nil, err
	}
...
func DefaultListEcomorph(ctx context.Context, db *gorm.DB) ([]*Ecomorph, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &EcomorphORM{}, &Ecomorph{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadInputEcomorph(ctx context.Context, in *InputEcomorph, db *gorm.DB) (*InputEcomorph, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &InputEcomorphORM{}); err != nil {
		return nil, err
	}
...
func DefaultListInputEcomorph(ctx context.Context, db *gorm.DB) ([]*InputEcomorph, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &InputEcomorphORM{}, &InputEcomorph{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
