...
func DefaultCreateTypePlant(ctx context.Context, in *TypePlant, db *gorm.DB) (*TypePlant, error) {
	...
	if err = db.Omit().Preload("EcomorphsEntity").Preload("Img").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateTypePlant(ctx context.Context, in *TypePlant, db *gorm.DB) (*TypePlant, error) {
	...
	if err = db.Model(&ormObj).Association("EcomorphsEntity").Replace(ormObj.EcomorphsEntity); err != nil {
		return nil, err
	}
	...
	if err = db.Omit().Preload("EcomorphsEntity").Preload("Img").Save(&ormObj).Error; err != nil {
		return nil, err
	}
